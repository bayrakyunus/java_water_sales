...
public class CustomerInsert extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Customer Insert");
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Customer Insert"));
    ...
    private void btnCustomerInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomerInsertActionPerformed
        ...
        if (!name.equals("") && !tel.equals("") ){
            int statu = db.customerInsert(name, mail, tel, address);
            if (statu == 1) {
                JOptionPane.showMessageDialog(rootPane, "Customer insert success.");
